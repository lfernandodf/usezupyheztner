...
module.exports = {
  up: (queryInterface: QueryInterface) => {
    return queryInterface.sequelize.query(
      ...
      INSERT INTO public."Settings" ("key", value, "createdAt", "updatedAt", "tenantId", id) VALUES('sessionIdleTimeoutMinutes', '5', '2020-12-12 16:08:45.354', '2020-12-12 16:08:45.354', 1, 11);
      `
    );
  },
